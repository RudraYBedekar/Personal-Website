...
const Contact = () => {
  ...
  const contactInfo = [
    {
      icon: <Mail size={24} />,
      title: 'Email',
      value: 'rudra.bedekar01@gmail.com',
          ...
          <div className={`lg:col-span-2 transition-all duration-1000 ${
            ...
            <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg h-full">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-8">
                Let's connect! Reach out through any of the following channels, 
                ...
                {contactInfo.map((item, index) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-900 dark:text-white group-hover:text-teal-600 dark:group-hover:text-teal-400 transition-colors duration-300">
                        {item.value}
                      </p>
                    </div>
                  </a>
  ...
  {[
    ...
    <a 
      key={index}
      href={social.url}
      className="w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center text-gray-700 dark:text-gray-300 hover:bg-teal-600 hover:text-white transition-colors duration-300"
      target="_blank"
      rel="noopener noreferrer"
      aria-label={`Follow on ${social.name.charAt(0).toUpperCase() + social.name.slice(1)}`}
    >
            ...
            <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg">
              ...
              <form onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                  <div>
                    ...
                    <input 
                      ...
                      } focus:outline-none focus:ring-2 focus:ring-teal-500 dark:bg-gray-700 dark:text-white`}
                ...
                <button 
                  ...
                  className="px-6 py-3 bg-teal-600 hover:bg-teal-700 text-white font-medium rounded-lg flex items-center justify-center transition-colors duration-300 disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:bg-teal-600"
                >
                  {isSubmitting ? (
                    <>
